...
namespace CourseManager.ViewModels
{
    internal class MainViewModel : Screen
    {
        ...
        private BindableCollection<TeacherModel> _teachers = new BindableCollection<TeacherModel>();
        ...
        public MainViewModel()
        {
            ...
            try
            {
                ...
                TeacherCommand teacherCommand = new TeacherCommand(_connectionString);
                Teachers.AddRange(teacherCommand.GetList());
        ...
        public BindableCollection<TeacherModel> Teachers
        {
        ...
        public void SaveEnrollment()
        {
            try
            {
                var enrollmentsDictiorany = _enrollments.ToDictionary(p => p.EnrollmentId);
